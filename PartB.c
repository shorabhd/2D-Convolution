...
int main(int argc, char* argv[])
{
	...
	MPI_Scatter(&data1[0][0], chunk*MAXN, MPI_COMPLEX,&data1[0][0], chunk*MAXN, MPI_COMPLEX,0,MPI_COMM_WORLD);
	MPI_Scatter(&data2[0][0], chunk*MAXN, MPI_COMPLEX,&data2[0][0], chunk*MAXN, MPI_COMPLEX,0,MPI_COMM_WORLD);	
	...
	MPI_Gather(&data1[0][0], chunk*MAXN, MPI_COMPLEX,&data1[0][0], chunk*MAXN, MPI_COMPLEX,0,MPI_COMM_WORLD);
	MPI_Gather(&data2[0][0], chunk*MAXN, MPI_COMPLEX,&data2[0][0], chunk*MAXN, MPI_COMPLEX,0,MPI_COMM_WORLD);
	...
	/*Collecting data3*/
	MPI_Gather(&data3[0][0], chunk*MAXN, MPI_COMPLEX,&data3[0][0], chunk*MAXN, MPI_COMPLEX,0,MPI_COMM_WORLD);
	...
	MPI_Scatter(&data3[0][0], chunk*MAXN, MPI_COMPLEX,&data3[0][0], chunk*MAXN, MPI_COMPLEX,0,MPI_COMM_WORLD);
